...
/**
 * @brief Here the function will convert from rupee to euro
 * 
 * @param rupee 
 * @return float 
 */
...
/**
 * @brief Here the function will convert from euro to rupee
 * 
 * @param euro 
 * @return float 
 */
...
/**
 * @brief Will convert cm to metre
 * 
 * @param cm 
 * @return float 
 */
...
/**
 * @brief will convert from metre to cm
 * 
 * @param m 
 * @return float 
 */
...
/**
 * @brief will convert from m to km
 * 
 * @param m 
 * @return float 
 */
...
/**
 * @brief will convert from km to m
 * 
 * @param km 
 * @return float 
 */
